...
public class BuildGraph {
	public static void BuildGraph(String fileName, String directory, int vertices, int dense, int maxCapacity, int minCapacity)
    {
	...
	public static void main(String[] args) {
		System.out.print("format: in commandline arg, filename, directory path, vertices, dense, maxcapacity, mincapacity ");
		BuildGraph(args[0], args[1], Integer.parseInt(args[2]), Integer.parseInt(args[3]), Integer.parseInt(args[4]), Integer.parseInt(args[5]));
	}
}